...
- Results/Errors from Executions can be handled by registering onSuccess
  and onError callbacks respectively. These callbacks return HandlerResults too!
...
- Could we make _all_ queries use PathExpressions? e.g. list github issues, etc. Even if they're not in model?
