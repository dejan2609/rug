 ...
 */
interface PathExpression<R extends TreeNode, N extends TreeNode> {
 ...
 */
  ...
  evaluate<R extends TreeNode,N extends TreeNode>(expr: PathExpression<R,N> | string): Match<R,N>
...
class Microgrammar implements DynamicType {
      constructor(public readonly name: string, public readonly grammar: string) {}
}
